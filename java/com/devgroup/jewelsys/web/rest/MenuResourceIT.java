...
class MenuResourceIT {
    ...
    private static final MenuStatus DEFAULT_STATUS = MenuStatus.ACTIVE;
    private static final MenuStatus UPDATED_STATUS = MenuStatus.INACTIVE;
    ...
    void createMenu() throws Exception {
        ...
        assertThat(testMenu.getRouterLink()).isEqualTo(DEFAULT_ROUTER_LINK);
    ...
    void putNewMenu() throws Exception {
        ...
        updatedMenu.menuCode(UPDATED_MENU_CODE).menuName(UPDATED_MENU_NAME).routerLink(UPDATED_ROUTER_LINK).status(UPDATED_STATUS);
        ...
        assertThat(testMenu.getRouterLink()).isEqualTo(UPDATED_ROUTER_LINK);
    ...
    void partialUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.menuName(UPDATED_MENU_NAME).status(UPDATED_STATUS);
    ...
    void fullUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.menuCode(UPDATED_MENU_CODE).menuName(UPDATED_MENU_NAME).routerLink(UPDATED_ROUTER_LINK).status(UPDATED_STATUS);
