...
describe('Component Tests', () => {
  describe('CounterInfo Management Component', () => {
    let comp: CounterInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CounterInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.counterInfos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
