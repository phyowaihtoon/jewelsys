...
describe('Component Tests', () => {
  describe('DataCategory Management Component', () => {
    let comp: DataCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DataCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dataCategories?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
