...
describe('Component Tests', () => {
  describe('GoldItem Management Component', () => {
    let comp: GoldItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GoldItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.goldItems?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
