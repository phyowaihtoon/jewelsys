...
describe('Component Tests', () => {
  describe('MenuGroup Management Component', () => {
    let comp: MenuGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MenuGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.menuGroups?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
