...
export class ShopInfoComponent implements OnInit {
  ...
  trackId(index: number, item: IShopInfo): number {
    return item.id!;
  }

  delete(shopInfo: IShopInfo): void {
    const modalRef = this.modalService.open(ShopInfoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IShopInfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
