...
class RoleMenuMapResourceIT {
    ...
    public static RoleMenuMap createEntity(EntityManager em) {
        RoleMenuMap roleMenuMap = new RoleMenuMap().roleId(DEFAULT_ROLE_ID);
        return roleMenuMap;
    }
    ...
    public static RoleMenuMap createUpdatedEntity(EntityManager em) {
        RoleMenuMap roleMenuMap = new RoleMenuMap().roleId(UPDATED_ROLE_ID);
        return roleMenuMap;
    }
    ...
    void putNewRoleMenuMap() throws Exception {
        ...
        updatedRoleMenuMap.roleId(UPDATED_ROLE_ID);
    ...
    void fullUpdateRoleMenuMapWithPatch() throws Exception {
        ...
        partialUpdatedRoleMenuMap.roleId(UPDATED_ROLE_ID);
